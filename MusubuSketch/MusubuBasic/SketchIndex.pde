public class SketchIndex {
  int col = 6;
  int row = 2;
  MusubuBasic parentApplet;
  MenuRectButton menuButton[] = new MenuRectButton[row * col];
  public SketchIndex(MusubuBasic _parentApplet){
...
public class MenuRectButton {
  ...
  boolean rollOvered;
  MusubuBasic parentApplet;
  public MenuRectButton(MusubuBasic _parentApplet, int _x, int _y, int _width, int _height, int _index){
    x = _x;
    y = _y;
    rwidth = _width;
    rheight = _height;
